...
cnn_model = CNNClassifier(
    max_features=10000,      # ↓ half vocab
    max_length=120,          # ↓ shorter sequences
    embedding_dim=64,        # ↓ half embedding size
    filter_sizes=[3, 4],     # ↓ fewer conv layers
    num_filters=64,          # ↓ half filters
